...
%   geoMap v2.0 | 15-Aug-2026 | Claude Opus 5 (Anthropic)
    ...
    methods (Access = private)
        ...
        function r = v1Root(tc)
            ...
            tc.assumeTrue(isfile(fullfile(r, "geoProject.m")), ...
                ['v1 tree absent, so oracle O12 is unreachable. This is ' ...
                 'the normal state on CI and a breach of OB-7 anywhere ' ...
                 'else. Filtered, not passed.']);
        end
    end

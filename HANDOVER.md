...
| G | G.0b | PV-152: the cross-element text-overlap check, and the repair it demands | ☐ **next** — the check is fifteen lines; the repair is layout work and is not started |
